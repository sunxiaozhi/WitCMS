...
class Tree {
     ...
     * @return array
     */
    public function getTree($pid = 0, $pk = 'id', $pidFeldName = 'parent_id', $cateFieldName = 'name', $adds = '') {
        $num = 1;
     ...
     * @return array
     */
    public function getGridTree($pid = 0, $pk = 'id', $pidFeldName = 'parent_id', $cateFieldName = 'name', $adds = '') {
        $num = 1;
