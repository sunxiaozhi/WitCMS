...
CREATE TABLE `wit_article_tag_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='文章标签映射表';
...
INSERT INTO `wit_article_tag_relation` VALUES ('51', '45', '11');
