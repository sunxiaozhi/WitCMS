...
CREATE TABLE `wit_article_tag_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='文章标签映射表';
...
INSERT INTO `wit_article_tag_relation` VALUES ('55', '45', '11');
